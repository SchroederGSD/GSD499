...
public class scr_HUD : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		GUI.DrawTexture (new Rect (Screen.width - 231f, Screen.height - 95f, 160f, 75f), txtBattery);
		GUI.DrawTexture (new Rect (Screen.width - intMeterAdjust, Screen.height - 85f, intCurrLength, 55f), txtCurrMeter);
